...
class PublicUserAPITestes(TestCase):
    ...
    def test_create_user_password_too_short_error(self):
        """Test error is returned if password too short."""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name',
    ...
    def test_create_token_for_user(self):
        """Test token for valid credatianls."""
        user_details = {
            'name': 'Test Name',
            'email': 'test@example.com',
    ...
    def test_create_token_bad_crediantls(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """Test revtrieving profile for logged in user."""
        res = self.client.get(ME_URL)
