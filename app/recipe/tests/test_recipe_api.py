...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        payload = {'title': 'New Recipe Titile'}
    ...
    def test_delete_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='test2@example.com', password='pass123')
    ...
    def test_create_tag_on_update(self):
        """Create tag when updating a recipe."""
        recipe = create_recipe(user=self.user)
        payload = {
            'tags': [
                {'name': 'Lunch'},
    ...
    def test_update_recipe_assign_tag(self):
        """Assign a existing tag when updating recipe."""
    ...
    def test_create_ingredient_on_update(self):
        """Test creaging a ingredient when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Apple Pie')
        tag1 = Tag.objects.create(user=self.user, name='Spicy')
        tag2 = Tag.objects.create(user=self.user, name='Pastry')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='French Toast')
        r2 = create_recipe(user=self.user, title='Chicken Cacciatore')
        in1 = Ingredient.objects.create(user=self.user, name='Toast Bread')
        in2 = Ingredient.objects.create(user=self.user, name='Chicken')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Salmon Soup')
